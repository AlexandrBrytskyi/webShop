...
<div class="wrap">
    ...
    <div style="width: 80%; margin: auto">
        ...
        <table class="table table-hover">
            ...
            <c:forEach items="${subcategories}" var="cat">
                <tr>
                    ...
                    <td>
                        <div class="btn_form">
                            <form style="width: 100%; margin: auto" action="${baseURL}shop/admin/subcategories/delete"
                                  method="post">
                                <input type="text" value="${cat.id}" hidden="hidden" name="subCategoryID"/>
                    ...
                    <td>
                        <div class="btn_form">
                            <form style="width: 100%; margin: auto"
                                  action="${baseURL}shop/admin/characteristics/${cat.id}">
                                <input type="submit" value="Manage Characteristics" title=""
                    ...
                    <td>
                        <div class="btn_form">
                            <form style="width: 100%; margin: auto"
                                  action="${baseURL}shop/item/create" method="get">
                                <input type="text" value="${cat.id}" hidden="hidden" name="subCategoryId"/>
                                <input type="submit" value="Add Item" title=""
                                       style="width: 100%; margin: auto"/>
                            </form>
                        </div>
                    </td>
        ...
        <form id="create_subcategory_form" action="${baseURL}shop/admin/subcategories/create" method="post">
            <div class="input-group">
                <span class="input-group-addon" id="sizing-addon2">Category
                    <select name="parentCategoryId" form="create_subcategory_form">
